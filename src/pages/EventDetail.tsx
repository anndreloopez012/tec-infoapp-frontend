...
import { Calendar, MapPin, Users, ArrowLeft, Download, ExternalLink, Share2 } from "lucide-react";
...
const EventDetail = () => {
  ...
  const handleAttendEvent = () => {
    ...
    toast({
      title: "¡Registrado!",
      description: "Te has registrado para asistir a este evento",
    });
  };
      ...
      <Card>
        ...
        <CardContent className="p-8 space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {format(new Date(event.start_date), "dd 'de' MMMM, yyyy 'a las' HH:mm", { locale: es })}
                  </p>
                </div>
              </div>
            )}
            ...
            {event.end_date && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {format(new Date(event.end_date), "dd 'de' MMMM, yyyy 'a las' HH:mm", { locale: es })}
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              {attendingStatus ? "Ya estás registrado" : "Asistir a evento"}
            </Button>
          ...
          <div>
            ...
            {event.content ? (
              ...
              <p className="text-muted-foreground">No hay descripción detallada disponible</p>
            )}
          </div>
        </CardContent>
      </Card>
